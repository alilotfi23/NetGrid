...
/**
 * Destructive delete action for an admin account, gated behind an inline
 * confirmation dialog. On confirm it DELETEs through the BFF route handler,
 * then refreshes the list. The backend rejects deleting yourself.
 */
export function AdminDeleteButton({ adminId, adminUsername }: Props) {
        ...
        >
          <div className="w-full max-w-sm rounded-xl border border-zinc-200 bg-white p-5 shadow-lg dark:border-zinc-800 dark:bg-zinc-950">
            ...
            <p className="mt-2 text-sm text-zinc-500 dark:text-zinc-400">
              ...
              and revokes their session tokens — they can no longer sign in.
